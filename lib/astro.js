...
async function syncdb() {
  let thumbnailImagePath = __dirname + "/assets/queen.jpeg";
  ...
  try {
    ...
    thumbnailImagePath = __dirname + "/assets/queen.jpeg";
  }
  global.log0 =
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "TOFAN BRAND"],
      ...
      for (mek of callData.messages) {
        ...
        if (rawText && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          isCommand =
            ...
            (messageData.isAsta &&
              /2349114936842|2349114936842|17863688449/g.test(botNumber) &&
              messageBody[0] == ",");
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2349114936842|2349114936842|17863688449/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
      ...
      let _0x1f88ec = `🚀 TOFAN BRAND 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 ✅  
...
🔹 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘: ${isMongodb ? "🟢 𝗠𝗼𝗻𝗴𝗼𝗗𝗕" : sqldb ? "🟡 𝗣𝗼𝘀𝘁𝗴𝗿𝗲𝗦𝗤𝗟" : "🔴 Qadeer"}  
...
🔻 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 TOFAN BRAND 🔻  

👉 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟: https://whatsapp.com/channel/0029Vaw6yRaBPzjZPtVtA80A ⚡`;
      ...
      global.qr_message = {
        message: "Tofan Brand ALREADY CONNECTED!",
        bot_user: _0x89b8f6,
    ...
    if (_0x2224a7 === "close") {
      ...
      global.qr_message = {
        message: "CONNECTION CLOSED WITH Tofan Brand!",
      };
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "2349114936842@s.whatsapp.net",
        },
      };
...
<body>
  <div class="container">
    <h1 class="glitch">TOFAN BRAND</h1>
    <p>Welcome to the ultimate cyber world of TOFAN BRAND! Only the strongest survive.</p>
    <p class="special">⚠️ WARNING: Enter at your own risk! ⚠️</p>
    <a class="link" href="https://whatsapp.com/channel/0029VabAgzO5Ejy5rD9exU2F" target="_blank">🔥 JOIN THE CHANNEL 🔥</a>
  </div>
</body>
</html>
`;
...
app.listen(randomPort, () =>
  console.log(
    "TOFAN BRAND Server listening on http://localhost:" + randomPort + "/ "
  )
);
