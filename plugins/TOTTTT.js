...
🔥 _Powered by TOFAN BRAND, the only bot that tolerates your stupidity._`;
...
smd(
      ...
      try {
        ...
        await message.reply(
          `📖 *Scripture Delivered... Too bad you're beyond saving.*\n\n` +
            ...
            `😈 *Powered by TOFAN BRAND, because even heaven rejected you.*`
        );
  ...
  `;
        ...
        await message.bot.sendMessage(
          ...
          {
            image: { url: imageUrl },
            caption: `🔥 *TOFAN BRAND's Unholy Booklist*:\n\n` + bibleList.trim(),
            contextInfo: {
              ...(await message.bot.contextInfo("TOFAN BRAND", message.senderName)),
            },
          },
          { quoted: message }
        );
  ...
  smd({
    ...
    try {
        ...
        const steps = [
            "💀 *TOFAN BRAND System Breach Initiating...* 💀",
            "",
            ...
            "",
            "💀 *Warning:* Next time, don’t mess with TOFAN BRAND.",
            "💀 *Warning:* Your weak security just got obliterated. 🧨",
            "💀 *Warning:* This is *your* fault. Now deal with it. 😈",
            "",
            "😈 *Powered by TOFAN BRAND, because you’re too dumb to stop this.*"
        ];
...
╭┈──────────────────•  
│  ◦ *Welcome to TOFAN BRAND (VRT)—now bow, peasant!*  
│  ◦
...
☠️ *Deal with it—Powered by TOFAN BRAND!* ☠️`;
...
smd(
  {
    ...
    alias: ["updates", "log"],
    react: "📢",
    desc: "Shows the latest TOFAN BRAND updates",
    category: "vortex",
    filename: __filename,
  },
  async (message) => {
    try {
      ...
      let log = `🚀 *TOFAN BRAND Update - v1.4.0* 🚀  
...
🔥 *Powered by TOFAN BRAND—FEAR has returned.* 🔥`;
      ...
      await message.reply(
        ...
        *_TOFAN BRAND doesn’t fail—YOU do._* 💀`
      );
    }
  }
);
...
smd(
  ...
  async (message) => {
    const githubRepoURL = "https://github.com/Qadeer-bhai/TOFAN-BRAND";
...
> 💀 *TOFAN BRAND isn't for the weak. If you can't handle raw power, GET LOST.*  
...
💀 *ＰＯＷＥＲＥＤ  ＢＹ  TOFAN BRAND* 💀`;
      ...
      await message.sendMessage(
        message.jid,
        {
          image: { url: "https://qu.ax/iUwuz.jpg" },
...
smd(
  ...
  async (message, match) => {
    try {
      ...
      const translationMessage = `💀 *TOFAN BRAND 𝐓𝐫𝐚𝐧𝐬𝐥𝐚𝐭𝐨𝐫* 💀
