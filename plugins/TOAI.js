  ...
  cmd(
    ...
    async (_0x4e4351) => {
      try {
        ...
        await _0x4e4351.send(util.format(_0x536aa6), {}, "TOFAN BRAND", _0x680da4);
      } catch (_0x2ee8cc) {
  ...
  cmd(
    ...
    async (_0xbda24) => {
      try {
        ...
        await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "TOFAN BRAND", _0x7d6de1);
      } catch (_0x1a2f02) {
    ...
    async (_0x397531) => {
      try {
        ...
        return await _0x397531.bot.sendUi(_0x397531.jid, {
          caption: `_TOFAN BRAND isn't for the weak._ 💀\n\n${_0x53eb40}\n\n*Powered by TOFAN BRAND*`
        });
      } catch (error) {
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("TOFAN BRAND • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("TOFAN BRAND • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*TOFAN BRAND • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
