 ...
 smd({
  ...
  async (message, match) => {
    try {
      ...
      imdbt += `🔹 *Powered by TOFAN BRAND — Unlike You, I'm Not a Flop!* 😈`;
  ...
  async (message, text) => {
    try {
      ...
      textw += `💀 *Powered by TOFAN BRAND — Now bow before me, weakling!* 😈`;
...
smd({
    ...
    try {
        ...
        result += `\n*Powered by TOFAN BRAND 🌀* (_Unlike you, I'm actually useful._)`;
...
smd({
    ...
    try {
        ...
        result += `┗━━━━━━━━━━━━━━━━━━━━━\n\n`;
        result += `\n*Powered by TOFAN BRAND 🌀* (_You're lucky I'm even helping you._)`;
