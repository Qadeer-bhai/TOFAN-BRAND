  ...
  async (message, args) => {
    try {
      ...
      let randomBranding = [
        ...
        "*⚡ TOFAN BRAND at its finest ⚡*",
        "*🔥 Bow before TOFAN BRAND 🔥*",
      ];
...
let tmpUrl = "https://telegra.ph/file/b8e96b599e0fa54d25940.jpgn";
const secmailData = {};
smd(
  {
    pattern: "tempmail",
