...
astro_patch.smd(
  {
    cmdname: "menu",
    desc: "TOFAN BRAND commands absolute dominance – kneel or perish.",
    react: "👑",
    type: "queen",
    filename: __filename,
  },
  async (message) => {
    try {
      ...
      const headers = [
        "╔═🔥 *TOFAN BRAND* 🔥═╗",
        "⫷⫸ 𝗤𝗔𝗗𝗘𝗘𝗥 𝗞𝗛𝗔𝗡 ⫷⫸",
        "⚠️ *TREMBLE BEFORE THE TOFAN'S POWER* ⚠",
      ...
      const introTexts = [
        "🔥 *𝐓𝐎𝐅𝐀𝐍 𝐁𝐑𝐀𝐍𝐃'𝐒 𝐀𝐁𝐒𝐎𝐋𝐔𝐓𝐄 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒* 🔥",
        "👑 *𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐓𝐇𝐄 𝐓𝐎𝐅𝐀𝐍’𝐒 𝐖𝐑𝐀𝐓𝐇* 👑",
