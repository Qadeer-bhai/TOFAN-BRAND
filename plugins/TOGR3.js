  ...
  cmd(
    ...
    async (_0x3a5b8e, _0x227613) => {
      try {
        ...
        await _0x3a5b8e.send(_0x7e4285 + "\n💀 *Powered by TOFAN BRAND*", { mentions: _0x2b9a05 });
  ...
  cmd(
    ...
    async (_0x5a67e3, _0x135d4c) => {
      try {
        ...
        await _0x5a67e3.send(_0x6b5a52 + "\n💀 *Powered by TOFAN BRAND*", { mentions: _0x1b7582 });
    ...
    async (_0x1f096a, _0x942e5e) => {
      try {
        ...
        let _0x20f7aa = (
          ...
          _0x13a9c9 +
          "\n*└───────────⊷*\n\n" +
          "🔥 *Powered by TOFAN BRAND. Now bow before me, mortals.*"
        ).trim();
