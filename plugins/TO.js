    ...
    async (message) => {
      try {
        ...
        const poweredBy = [
          ...
          "💀 TOFAN BRAND - 𝙉𝙤𝙩 𝙔𝙤𝙪𝙧 𝘼𝙫𝙚𝙧𝙖𝙜𝙚 𝘽𝙤𝙩 💀",
          "🔥 𝙏𝙝𝙚 𝙎𝙮𝙨𝙩𝙚𝙢 𝙊𝙗𝙚𝙮𝙨 TOFAN BRAND 🔥"
        ];
...
astro_patch.cmd(
  ...
  function randomPower() {
    let styles = [
      "⚡ 𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 TOFAN BRAND ⚡",
      "🔥 𝘾𝙤𝙣𝙩𝙧𝙤𝙡𝙡𝙚𝙙 𝙗𝙮 TOFAN BRAND 🔥",
      "💀 𝙈𝙖𝙨𝙩𝙚𝙧𝙚𝙙 𝙗𝙮 TOFAN BRAND 💀",
      "🔮 𝙏𝙝𝙚 𝙎𝙥𝙞𝙧𝙞𝙩 𝙤𝙛 TOFAN BRAND 𝙍𝙚𝙞𝙜𝙣𝙨 🔮",
      "💢 𝙉𝙚𝙫𝙚𝙧 𝙦𝙪𝙚𝙨𝙩𝙞𝙤𝙣 TOFAN BRAND 💢",
    ];
...
function randomPower() {
  let styles = [
    "⚡ 𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 TOFAN BRAND ⚡",
    "🔥 𝘾𝙤𝙣𝙩𝙧𝙤𝙡𝙡𝙚𝙙 𝙗𝙮 TOFAN BRAND 🔥",
    "💀 𝙏𝙝𝙚 𝙎𝙝𝙖𝙙𝙤𝙬 𝙊𝙛 TOFAN BRAND 𝙍𝙚𝙞𝙜𝙣𝙨 💀",
    "💢 𝙉𝙤 𝙈𝙚𝙧𝙘𝙮 - TOFAN BRAND 💢",
    "🔮 𝙏𝙝𝙞𝙨 𝙞𝙨 𝙈𝙮 𝘿𝙤𝙢𝙖𝙞𝙣 - TOFAN BRAND 🔮",
  ];
  return styles[Math.floor(Math.random() * styles.length)];
}
